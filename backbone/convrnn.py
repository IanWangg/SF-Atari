...
class ConvGRU(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, kernel_size, num_layers, dropout=0.1):
        ...
        print(f'number of cells used in ConvGRU : {len(cell_list)}')
    ...
    def forward(self, x, hidden_state=None):
        # here the seq_len is not the actual seq_len, is the number of sequences
        # or the number of output we will get
        [B, seq_len, *_] = x.size()
